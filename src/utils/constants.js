...
export const MODES = {
  ...
  OFFICE_CHAT: {
    ...
    icon: '🏢',
    color: '#22c55e',
    description: 'Coffee break conversations, networking, introductions, conferences.',
...
export const AMBIENTS = {
  NONE: { id: 'none', name: 'None', icon: '🔇' },
  COFFEE_SHOP: { id: 'coffee_shop', name: 'Coffee Shop', icon: '☕' },
  OFFICE: { id: 'office', name: 'Office', icon: '🏢' },
  HOME: { id: 'home', name: 'Home Office', icon: '🏠' },
  COWORKING: { id: 'coworking', name: 'Coworking', icon: '💻' },
};
